...
function emailCard(opts: {
  ...
  return [
    ...
    "</div>",
    "</div>",
    '<p style="text-align:center;font-size:12px;color:#94a3b8;margin:16px 0 0">Powered by JobMatch AI</p>',
    "</div>",
  ].join("");
}
    ...
    const html = autoSubmitReason
      ? `
        <div style="font-family: sans-serif; line-height: 1.6; color: #333;">
          ...
          <p style="font-size: 14px; color: #666;">This is an automated message from JobMatch AI.</p>
        </div>
      `
      : `
        <div style="font-family: sans-serif; line-height: 1.6; color: #333;">
