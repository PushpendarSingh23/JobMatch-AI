# JobMatch AI Road to GA

This is the plan for getting JobMatch AI to `v1.0.0` (general availability). It tracks what is left, why each item matters, and what is already done.
...
🟢 **Complete and verified in production on 6 Aug 2026.** A deliberate change to the `/health` response string was pushed and confirmed live at `api.jobmatch-ai.dev`, proving the VM now receives new code. Before this, deploys had been silently failing since at least 3 Aug 2026 while reporting success.
