# Setting up WSO2 Identity Platform for JobMatch AI

JobMatch AI uses WSO2 Identity Platform for identity and access management. This guide walks you through creating an Identity Platform application so you can log in to your local JobMatch AI instance.
...
- **Name**: any name you like, e.g. `JobMatch AI`
...
JobMatch AI manages users and roles through Asgardeo's SCIM2 and User Credential Management APIs, so the application needs access to them.
...
Open the **Advanced** tab and tick **Enable app-native authentication API** under **App-Native Authentication**. JobMatch AI uses in-app login forms instead of redirecting to the Asgardeo hosted login page, so this needs to be enabled.
